...
const char *WEBPAGE_CONFIG_BODY =
        ...
        "document.getElementById('num_programs').value=(c.n_prg&&[1,2,4,6,8,10].includes(Number(c.n_prg)))?c.n_prg:10;"
...
"<div class='container'>"
        ...
        "</div></div>"
        "<div class='test-item'><span class='test-label'>ADDR gettoniera (default 2)</span>"
        "<div class='test-controls'>"
        "  <input type='number' id='cctalk_addr' min='1' max='255' value='2' style='width:80px' onchange=\"saveCctalkAddr(true)\">"
        "</div></div>"
