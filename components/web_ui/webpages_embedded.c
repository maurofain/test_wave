...
"<div class='container'>"
        ...
        "      out += '<span style=\"background:#f9e79f;color:#7b241c;font-weight:bold;padding:0 2px;border-radius:2px;\">.' + hex + '</span>';"
        "      continue;"
        "    }"
        "    if(forceHex || mode === 'HEX') out += '<span style=\"color:'+color+'\">.' + hex + '</span>';"
