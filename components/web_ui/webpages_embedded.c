...
const char *WEBPAGE_CONFIG_BODY =
        ...
        "const slideshowSpeed=(timeoutsCfg&&timeoutsCfg.slideshow_speed_ms)?parseInt(timeoutsCfg.slideshow_speed_ms,10):5000;"
...
"scanner:{en:document.getElementById('scanner_en').checked,vid:document.getElementById('scanner_vid').value,pid:document.getElementById('scanner_pid').value,dpid:document.getElementById('scanner_dual_pid').value,cool:parseInt(document.getElementById('scanner_cooldown_ms').value)||10000},"
        "timeouts:{t_prg:(Math.max(1,Math.min(600,parseInt(document.getElementById('timeout_language_return_s').value)||60))*1000),t_lang:(Math.max(1,Math.min(600,parseInt(document.getElementById('timeout_language_exit_s').value)||60))*1000),slideshow_speed_ms:Math.max(1000,Math.min(30000,parseInt(document.getElementById('slideshow_speed_ms').value)||5000))},"
