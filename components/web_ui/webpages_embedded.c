...
const char *WEBPAGE_CONFIG_BODY =
        ...
        "<button type='button' onclick='triggerLvglPage(\"programs_v2\")'>Programmi v2</button>"
...
"<div class='emu-wrap'>"
        ...
        "/* Avvia automaticamente sequenza CCTALK (Abilita) all'apertura della pagina Programmi */"
        "fetch('/api/test/cctalk_start',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({addr:2})}).catch(function(e){console.warn('cctalk start failed',e);});"
