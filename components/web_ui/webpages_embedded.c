...
"<div class='container'>"
        ...
        "<div class='test-controls'>"
        "  <button onclick=\"runCctalkAction('retention_on')\" style='background:#16a085'>🪙 Ritenzione ON</button>"
        "  <button onclick=\"runCctalkAction('retention_off')\" class='btn-stop'>🚫 Ritenzione OFF</button>"
        "</div></div>"
        ...
        "    else if(action === 'retention_on') endpoint = 'cctalk_retention_on';"
        "    else if(action === 'retention_off') endpoint = 'cctalk_retention_off';"
        "    const r = await fetch('/api/test/' + endpoint, {method:'POST'});"
