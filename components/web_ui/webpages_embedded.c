...
const char *WEBPAGE_CONFIG_BODY =
        ...
        "<div class='sw-row'><label class='switch'><input type='checkbox' id='enable_api_log' name='enable_api_log'><span class='slider'></span></label><span>Abilita log POST/GET API</span></div>"
...
"<div class='container'>"
        ...
        "  <button onclick=\"runCctalkAction('enable_ch1_4')\" style='background:#1abc9c'>✅ Abilita CH1-CH4</button>"
        ...
        "  try{"
        "    const commentsEl = document.getElementById('cctalk_comments');"
        "    if(commentsEl && !commentsEl.checked){ commentsEl.checked = true; }"
        ...
        "    else if(action === 'enable_ch1_4') endpoint = 'cctalk_retention_ch1_4';"
