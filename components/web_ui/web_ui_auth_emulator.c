...
esp_err_t emulator_page_handler_local(httpd_req_t *req)
{
    ...
    const char *extra_style =
        ...
        ".prog-btn{border:none;border-radius:8px;background:#2c3e50 !important;color:#fff;font-size:17px;font-weight:bold;cursor:pointer;padding:6px 4px;line-height:1.1}"
        ".prog-btn.active{background:#e74c3c !important}"
